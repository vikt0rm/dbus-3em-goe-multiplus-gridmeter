...
class DbusShelly3emService:
  ...
  def _update(self):   
    try:
       ...
       self._dbusservice['/Ac/L1/Power'] = meter_data['emeters'][0]['power'] + self._validGoeL3Power
       self._dbusservice['/Ac/L2/Power'] = meter_data['emeters'][1]['power'] + self._validGoeL2Power
       self._dbusservice['/Ac/L3/Power'] = meter_data['emeters'][2]['power'] + self._validGoeL1Power
